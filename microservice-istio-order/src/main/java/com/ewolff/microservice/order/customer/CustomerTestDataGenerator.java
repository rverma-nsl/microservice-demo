...
public class CustomerTestDataGenerator {
  ...
  private void createIfNotExist(String firstname, String name, String email, String street,
                                String city) {
  ...
  public void generateTestData() {
    createIfNotExist("Eberhard", "Wolff", "eberhard.wolff@posteo.net", "Unter den Linden",
        "Berlin");
